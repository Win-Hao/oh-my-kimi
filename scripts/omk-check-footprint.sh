...
ALLOWED='^(apps/kimi-code/src/main\.ts|apps/kimi-code/package\.json|README\.md|README\.en\.md|README\.zh-CN\.md|CLAUDE\.md|DIVERGENCES\.md|\.gitignore|pnpm-lock\.yaml)$'
